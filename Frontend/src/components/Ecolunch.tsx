...
const EcoLaunch = () => {
  return (
    <div className="font-[Montserrat] text-[#222] m-0 p-0 bg-white">
      ...
      <main className="flex flex-wrap p-[130px_60px] bg-[#fafafa] relative bg-[url('img.avif')] bg-cover bg-center bg-no-repeat h-[620px]">
        <div className="flex-1 min-w-[350px] z-[2]">
          ...
          <h1 className="text-[60px] font-extrabold my-2 tracking-tight text-black">
            Eco<span className="text-black text-[70px]">X</span>change
          </h1>
          ...
          <div className="flex gap-5 mt-[25px]">
            <Link to="/signup" className="bg-[#f7c948] py-[12px] px-[22px] rounded-full font-bold text-black no-underline hover:bg-[#f0b429] transition">SELL HERE</Link>
            <Link to="/signup" className="bg-[#f7c948] py-[12px] px-[22px] rounded-full font-bold text-black no-underline hover:bg-[#f0b429] transition">BUY HERE</Link>
          </div>
        </div>
      </main>
