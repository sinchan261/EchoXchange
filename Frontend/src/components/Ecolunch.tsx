      ...
      {/* <header className="flex justify-between items-center p-[15px_40px] bg-white border-b border-[#eee]">
        ...
        <nav>
          <ul className="flex gap-[30px] list-none m-0 p-0">
            ...
            <li>
              <Link to="/checkout" className="text-[#666] font-medium text-[16px] hover:text-black transition-colors">Cart</Link>
            </li>
            <li>
              <Link to="/wishlist" className="text-[#666] font-medium text-[16px] hover:text-black transition-colors">Wishlist</Link>
            </li>
            <li>
              <Link to="/contact" className="text-[#666] font-medium text-[16px] hover:text-black transition-colors">Contact Us</Link>
            </li>
          </ul>
        </nav>
      </header> */}
